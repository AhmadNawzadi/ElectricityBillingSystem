...
CREATE TABLE `meter` (
  ...
  CONSTRAINT `meter_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`)
...
INSERT INTO `meter` VALUES (1,23456789,'Inside','Electric Meter','001','Monthly',4),(2,23456791,'Inside','Smart Meter','002','Monthly',7);
